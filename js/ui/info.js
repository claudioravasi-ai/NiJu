...
function preguntas(){
  ...
  return [
    ...
    ['Compras al exterior', '¿Cuánto puedo traer por courier?', [`Con los valores que usa la app: hasta US$ ${cr.topeValorUSD} y ${cr.topePesoKg} kg por envío, para uso personal. Hasta ${cr.franquiciasPorAnio} envíos por año y ${cr.unidadesPorItem} unidades iguales. Los primeros US$ ${cr.franquiciaUSD} FOB de cada envío no pagan derecho de importación ni tasa de estadística; sobre lo que supera se pagan esos dos. El IVA se paga siempre. Si te pasás de algún límite, va exclusivamente con despachante.`], [['Calculadora', '#/impuestos?tab=calc'], 'envios']],
