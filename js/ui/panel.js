...
const PENDIENTES = [
  { q:'Conectar Mercado Pago', listo:false,
    d:'Sin esto no podés cobrar: ni NiJu Directo, ni las señas de preventa, ni las de la bolsa de demanda. Es lo que convierte la app en un negocio.',
    donde:'Checkout Pro + credenciales en el backend' },
  ...
  { q:'Crear el almacén KV en Cloudflare', listo:false,
    d:'Sin esto, las campañas y la bolsa de demanda viven en cada navegador por separado: nadie ve lo que hizo el otro.',
    donde:'Workers → KV → enlazar como NIJU' },
